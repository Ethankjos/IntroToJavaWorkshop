...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("scream.wav.wav"));
	...
	private void showScaryImage(String imageName) {
		...
		frame.setSize(maze.getWidth(), maze.getHeight());
	...
	@Override
	public void run() {
		frame = new JFrame("June's Scary Maze");
		frame.add(this);
